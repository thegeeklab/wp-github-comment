...
func (_m *MockIssueService) CreateComment(ctx context.Context, owner string, repo string, number int, comment github.IssueCommentRequest) (*github.IssueComment, *github.Response, error) {
	...
	var r2 error
	if rf, ok := ret.Get(0).(func(context.Context, string, string, int, github.IssueCommentRequest) (*github.IssueComment, *github.Response, error)); ok {
		return rf(ctx, owner, repo, number, comment)
	}
	if rf, ok := ret.Get(0).(func(context.Context, string, string, int, github.IssueCommentRequest) *github.IssueComment); ok {
	...
	if rf, ok := ret.Get(1).(func(context.Context, string, string, int, github.IssueCommentRequest) *github.Response); ok {
	...
	if rf, ok := ret.Get(2).(func(context.Context, string, string, int, github.IssueCommentRequest) error); ok {
...
func (_c *MockIssueService_CreateComment_Call) Run(run func(ctx context.Context, owner string, repo string, number int, comment github.IssueCommentRequest)) *MockIssueService_CreateComment_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(string), args[2].(string), args[3].(int), args[4].(github.IssueCommentRequest))
	})
	return _c
}
...
func (_c *MockIssueService_CreateComment_Call) RunAndReturn(run func(context.Context, string, string, int, github.IssueCommentRequest) (*github.IssueComment, *github.Response, error)) *MockIssueService_CreateComment_Call {
	_c.Call.Return(run)
	return _c
}
...
// UpdateComment provides a mock function with given fields: ctx, owner, repo, commentID, comment
func (_m *MockIssueService) UpdateComment(ctx context.Context, owner string, repo string, commentID int64, comment github.IssueCommentRequest) (*github.IssueComment, *github.Response, error) {
	...
	var r1 *github.Response
	var r2 error
	if rf, ok := ret.Get(0).(func(context.Context, string, string, int64, github.IssueCommentRequest) (*github.IssueComment, *github.Response, error)); ok {
		return rf(ctx, owner, repo, commentID, comment)
	}
	if rf, ok := ret.Get(0).(func(context.Context, string, string, int64, github.IssueCommentRequest) *github.IssueComment); ok {
	...
	if rf, ok := ret.Get(1).(func(context.Context, string, string, int64, github.IssueCommentRequest) *github.Response); ok {
	...
	if rf, ok := ret.Get(2).(func(context.Context, string, string, int64, github.IssueCommentRequest) error); ok {
...
// MockIssueService_UpdateComment_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'UpdateComment'
type MockIssueService_UpdateComment_Call struct {
	*mock.Call
}
...
//   - commentID int64
//   - comment github.IssueCommentRequest
func (_e *MockIssueService_Expecter) UpdateComment(ctx interface{}, owner interface{}, repo interface{}, commentID interface{}, comment interface{}) *MockIssueService_UpdateComment_Call {
	return &MockIssueService_UpdateComment_Call{Call: _e.mock.On("UpdateComment", ctx, owner, repo, commentID, comment)}
}

func (_c *MockIssueService_UpdateComment_Call) Run(run func(ctx context.Context, owner string, repo string, commentID int64, comment github.IssueCommentRequest)) *MockIssueService_UpdateComment_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(string), args[2].(string), args[3].(int64), args[4].(github.IssueCommentRequest))
	})
	return _c
}

func (_c *MockIssueService_UpdateComment_Call) Return(_a0 *github.IssueComment, _a1 *github.Response, _a2 error) *MockIssueService_UpdateComment_Call {
	_c.Call.Return(_a0, _a1, _a2)
	return _c
}

func (_c *MockIssueService_UpdateComment_Call) RunAndReturn(run func(context.Context, string, string, int64, github.IssueCommentRequest) (*github.IssueComment, *github.Response, error)) *MockIssueService_UpdateComment_Call {
	_c.Call.Return(run)
	return _c
}
